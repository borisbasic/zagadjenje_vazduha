...
zagadjenje_vazduhacsv = pd.read_csv(r'C:\Users\XXXX\Documents\pythonProject\zagadjenje_vazduha_crna_gora.csv')
zagadjenje_vazduhacsv = pd.concat([zagadjenje_vazduhacsv, dejta_frejm])
zagadjenje_vazduhacsv.to_csv(r'C:\Users\XXXX\Documents\pythonProject\zagadjenje_vazduha_crna_gora.csv', index=None)
# GRAFIKON
...
plt.savefig(r'C:\Users\XXXX\OneDrive\zagadjenje_vazduha_slike\zagadjenje_vazduha_crna_gora'+str(datetime.date.today().strftime("%d.%m.%Y"))+'.png')
