...
time.sleep(2)
zagadjenje_vazduhacsv = pd.read_csv(r'C:\Users\XXXX\Documents\pythonProject\zagadjenje_vazduha.csv')
time.sleep(2)
zagadjenje_vazduhacsv = pd.concat([zagadjenje_vazduhacsv, dejta_frejm])
time.sleep(2)
zagadjenje_vazduhacsv.to_csv(r'C:\Users\XXXX\Documents\pythonProject\zagadjenje_vazduha.csv', index=None)
# GRAFIKON
...
plt.savefig(r'C:\Users\XXXX\OneDrive\zagadjenje_vazduha_slike\zagadjenje_vazduha'+str(datetime.date.today().strftime("%d.%m.%Y"))+'.png')
